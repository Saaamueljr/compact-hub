// Cloudflare Pages Function — roda em /api/analyze
// A chave nunca aparece no navegador: fica em env.GEMINI_API_KEY (configurada
// no painel do Cloudflare Pages em Settings > Environment variables > Secret).
...
export async function onRequestPost(context) {
  ...
  // gemini-2.5-flash: modelo estável com tier gratuito e suporte a busca.
  // Confira o nome/disponibilidade atual em https://ai.google.dev/gemini-api/docs/pricing
  // antes de trocar via env.GEMINI_MODEL.
